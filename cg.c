...
// Load an global variable value into a register.
// Return the number of the register.
...
static char *cmplist[6] = { "sete", "setne", "setl", "setg", "setle", "setge" };
...
static char *invcmplist[6] = { "jne", "je", "jge", "jle", "jg", "jl" };
